...
NO_NAME_MANGLING
void singular_parallel_all_compute ( std::string const& base_filename
                                   ...
                                   )
{
  ...
  const std::string in_filename = base_filename + ".i" + std::to_string (id);
  ...
  if (out.first != out_type)
  {
    ...
    + std::to_string (id) + ", expected " + std::to_string (out_type)
    + " got " + std::to_string (out.first));
  }
  const std::string out_filename = base_filename + ".o" + std::to_string (id);
